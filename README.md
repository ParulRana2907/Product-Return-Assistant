...
Delayed refund decisions

Increasing return fraud
...
Automates return eligibility decisions

Calculates fraud risk using behavior and trust level

Tracks refund status

Suggests exchanges when refunds are risky
